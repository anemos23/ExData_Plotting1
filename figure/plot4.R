...
par(mfrow=c(2,2))
    plot(df_time$timeline, df_time$Global_active_power, type = "l", ylab = "Global active power", xlab = "", xaxt = "n")
      axis(1, at = c(1, 1440, 2880), labels = c("Thu", "Fri", "Sat"), tick = TRUE)
    plot(df_time$timeline, df_time$Voltage, type = "l", ylab = "Voltage", xlab = "datetime", xaxt = "n")
      axis(1, at = c(1, 1440, 2880), labels = c("Thu", "Fri", "Sat"), tick = TRUE)
    plot(df_time$timeline, df_time$Sub_metering_1, type = "l", ylab = "Global active power", xlab = "", xaxt = "n")
      axis(1, at = c(1, 1440, 2880), labels = c("Thu", "Fri", "Sat"), tick = TRUE)
    ...
    plot(df_time$timeline, df_time$Global_reactive_power, type = "l", ylab = "Global_reactive_power", xlab = "datetime", xaxt = "n")
      axis(1, at = c(1, 1440, 2880), labels = c("Thu", "Fri", "Sat"), tick = TRUE)
dev.off()
